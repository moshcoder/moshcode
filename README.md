...
| `moshcode games` <br>`game` `arcade` | arcade | the moshcode arcade — sixteen games, no menus |
...
Sixteen games, in the pit or straight from a shell. There are no menus, no options
